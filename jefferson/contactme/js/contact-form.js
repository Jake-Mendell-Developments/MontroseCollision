...
const emails = [
  ...
  'snewsome@gomontrose.com',
  'hmiller@gomontrose.com',
  'jpease@gomontrose.com',
];

const sendEmail = async (emails, values) => {
  const { name, email, phone, car, message } = values;
  const location = 'Montrose Collision Center of Jefferson';
  const _subject = 'New Collision Center of Jefferson submission!';
