...
$configs['from_name']				= 'Aytomic Test';								// Your name will be used in emails
$configs['from_address']			= 'pacozait@gmail.com';							// Your email address used to send emails
$configs['to_addresses']			= array('pacozait@gmail.com');						// The addresse(s) where to send all the requests
/* END - Required Config */
